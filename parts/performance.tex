...
\node [right] at (axis cs:11, 0.46) {\scriptsize measuremements};
...
\foreach \i in {1, 2, 3}{
	\addplot [col!20, mark=*, mark size=1pt, visible on=<3->]
		table [x=Toa, y=Q_at_f1_Tr\i] {data/Qh-To-gen.tsv};}
\node [col!20, right, xshift=3mm, visible on=<3->]
	at (axis cs:15, 2.287) {$ \nu = 0.1 $};

\foreach \i in {1, 2, 3}{
	\addplot [col!60, mark=*, mark size=1pt, visible on=<2->]
