...
% temporary length to locally replace long length calculations
\newlength\templen
...
\newcommand{\Qh}{\xmath{\dot Q_\text{h}}}	% heating capacity
\newcommand{\Qc}{\xmath{\skew{5}\dot Q_\text{c}}}	% cooling capacity
\newcommand{\Qcs}{\xmath{\dot Q_\text{cs}}}	% sensible cooling capacity
\newcommand{\Qcl}{\xmath{\dot Q_\text{cl}}}	% latent cooling capacity
\newcommand{\Pel}{\xmath{P_\text{el}}}		% electrical input power
\newcommand{\fc}[1][]{\xmath{f_{c#1}}}		% compressor frequency
\newcommand{\fcn}[1][]{\xmath{\nu_{#1}}}	% norm. compressor frequency
\newcommand{\Tr}[1][]{\xmath{T_{r#1}}}		% return air temperature
\newcommand{\Twbr}[1][]{\xmath{T_{{\text{wb}r#1}}}}	% return air wet-bulb
\newcommand{\Ts}{\xmath{T_s}}				% supply air temperature
\newcommand{\To}[1][]{\xmath{T_{o#1}}}		% outdoor air temperature
\newcommand{\mr}{\xmath{\dot m_\text{r}}}	% refrigerant mass flow rate
